...
If you discover a security vulnerability in **SSH Honeypot**, **do not** open a public GitHub issue. Report it privately.

**Report via GitHub Security Advisory:**
1. Go to the repository's **Security** tab
2. Click **Report a vulnerability** (or use `https://github.com/Dev9269/ssh-honeypot/security/advisories/new`)
