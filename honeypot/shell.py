                ...
                "children": {
                    "ubuntu": {
                        ...
                        "children": {
                            ...
                            "notes.txt": {
                                "type": "file",
                                "content": "TODO: update server config\n",
                            },
                        },
                    },
                },
                ...
                "children": {
                    "log": {
                        ...
                        "children": {
                            "auth.log": {
                                "type": "file",
                                "content": "Jun 24 10:15:22 sshd[1234]: Accepted password for root\n",
                            },
                            "syslog": {
                                "type": "file",
                                "content": "Jun 24 10:15:00 kernel: [    0.000000] Linux version 5.15.0-91-generic\n",
                            },
                        },
                    },
...
def handle_command(cmd: str, ip: str, username: str, cwd: str = "/root") -> str:
    ...
    _get_logger().log_session_activity(ip, f"command: {cmd_norm}", username=username)
    if cmd_norm == "pwd":
        return cwd + "\r\n"
