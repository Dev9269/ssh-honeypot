...
def load_yaml_config(config_path: Optional[str] = None) -> bool:
    ...
    g["RATE_LIMIT_MAX_CONNECTIONS"] = rate.get(
        "max_connections", RATE_LIMIT_MAX_CONNECTIONS
    )
    ...
    g["INTEL_VIRUSTOTAL_KEY"] = intel.get("virustotal_key", INTEL_VIRUSTOTAL_KEY)
